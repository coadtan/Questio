...
public class QuestioConstants {
    public static final String BASE_URL = "http://52.74.21.41";
    public static final String BASE_QUESTIO_MANAGEMENT = "http://52.74.21.41/questio_management";
    public static final String ENDPOINT = "http://52.74.21.41/questio_management/api";
