 ...
 */
public class DoQuizActivity extends ActionBarActivity implements View.OnClickListener {
    private static final String LOG_TAG = DoQuizActivity.class.getSimpleName();
...
//        quizChoice4.setBackground(getResources().getDrawable(R.drawable.answer_button));
    ...
    void onAnswer(final int choiceSelected) {
        final Dialog dialog = new Dialog(DoQuizActivity.this);
