 ...
 */
public class HOFActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    @BindView(R.id.hof_reward)
    GridView hallOfFame;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.hof_activity_layout);
